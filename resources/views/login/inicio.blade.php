  ...
  <div class="row">
    <div class="col-md-4 offset-md-4 rounded" style="background:url(assets/images/fondo_azul1024.png)">
      ...
      <div class="form-group">
        ...
        {{ Form::password('password', array('placeholder'=> 'Contraseña', 'class'=>'text-center form-control mb-2 mt-1', 'required'=> 'required'))}}
        {{ Form::button('<a><i class="fas fa-user"></i> Ingresar</a>',array('class'=> 'btn btn-primary btn-block login mb-1 mt-3','onClick'=>''))  }}
