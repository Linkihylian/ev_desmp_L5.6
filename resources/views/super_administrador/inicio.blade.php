...
<div class="card">
  <div class="card-body">
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
      ...
      <li class="nav-item">
        <a class="nav-link" id="pills-odi-tab" data-toggle="pill" href="#pills-odi" role="tab" aria-controls="pills-odi" aria-selected="false">2. Objetivos de desempeño individual <i class="fas fa-angle-right"></i></a>
    ...
    <div class="tab-content" id="pills-tabContent">
                  ...
                  <tr>
                    ...
                    <th scope="col">
                      <div class="btn-group" role="group" aria-label="Basic example">
                        <button type="button" class="btn btn-sm btn-info" title="Agregar ODI" onclick="modal_agregar_odi()"><i class="fas fa-plus"></i></button>
                      </div>
                    </th>
                  </tr>
                </thead>
              ...
              <table class="table table-hover" id="tabla_categoria">
                ...
                <tbody>
                  <tr>
                    ...
                    <td colspan="2" >
                      <button type="button" class="btn btn-sm btn-block btn-info" title="Eliminar" onclick=""><i class="fas fa-check"></i></button>
                    </td>
                  </tr>
              ...
              <table class="table table-hover" id="tabla_cargo">
                ...
                <tbody>
                  <tr>
                    ...
                    <td colspan="2" >
                      <div class="btn-group" role="group" aria-label="Basic example">
                        <button type="button" class="btn btn-sm btn-info" title="Eliminar" onclick=""><i class="fas fa-check"></i></button>
                      </div>
                    </td>
                  </tr>
      ...
      <div class="tab-pane fade" id="pills-competencias" role="tabpanel" aria-labelledby="pills-competencias-tab">
        ...
        <div class="row">
          ...
          <!-- card para gestionar las competencias -->
      ...
      <!-- duracion -->
      <div class="tab-pane fade" id="pills-duracion" role="tabpanel" aria-labelledby="pills-duracion-tab">..5.</div>
    </div>
...
<script src="{{ asset("js/evaluacion/evaluacion.js") }}" charset="utf-8"></script>
...
<script src="{{ asset("js/evaluacion/modal_agregar_odi.js") }}" charset="utf-8"></script>
<script src="{{ asset("js/evaluacion/modal_editar_odi.js") }}" charset="utf-8"></script>
<script src="{{ asset("js/evaluacion/comp_mostrar_periodos.js") }}" charset="utf-8"></script>
<script src="{{ asset("js/evaluacion/mostrar_categorias.js") }}" charset="utf-8"></script>
